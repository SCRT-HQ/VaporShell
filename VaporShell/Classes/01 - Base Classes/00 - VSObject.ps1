...
class VSObject : object {
    ...
    VSObject([IDictionary] $props) {
        ...
        $props.GetEnumerator() | ForEach-Object {
            ...
            if ($_.Key -eq 'Fn::Transform' -or ($this.PSObject.Properties.Name -contains $_.Key -and $_.Key -notin [PSCommonParameters].GetEnumValues())) {
    ...
    VSObject([psobject] $props) {
        ...
        $props.PSObject.Properties | ForEach-Object {
            ...
            if ($_.Name -eq 'Fn::Transform' -or ($this.PSObject.Properties.Name -contains $_.Name -and $_.Name -notin [PSCommonParameters].GetEnumValues())) {
