function Add-VSWAFv2WebACLMethod {
    <#
    .SYNOPSIS
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.WAFv2.WebACL.Method')]
    [cmdletbinding()]
    Param
    (
    )
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.WebACL.Method'
