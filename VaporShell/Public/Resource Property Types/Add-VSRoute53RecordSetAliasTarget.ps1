function Add-VSRoute53RecordSetAliasTarget {
    <#
    .SYNOPSIS
        Adds an AWS::Route53::RecordSet.AliasTarget resource property to the template. *Alias resource record sets only:* Information about the AWS resource, such as a CloudFront distribution or an Amazon S3 bucket, that you want to route traffic to.
