function Add-VSWAFv2RuleGroupUriPath {
    <#
    .SYNOPSIS
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.WAFv2.RuleGroup.UriPath')]
    [cmdletbinding()]
    Param
    (
    )
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.RuleGroup.UriPath'
