function Add-VSWAFv2WebACLNoneAction {
    <#
    .SYNOPSIS
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.WAFv2.WebACL.NoneAction')]
    [cmdletbinding()]
    Param
    (
    )
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.WebACL.NoneAction'
