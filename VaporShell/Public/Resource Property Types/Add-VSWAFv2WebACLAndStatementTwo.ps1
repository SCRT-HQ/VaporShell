function Add-VSWAFv2WebACLAndStatementTwo {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::WebACL.AndStatementTwo resource property to the template. Logical AND statement used in statement nesting.
...
Logical AND statement used in statement nesting.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.WAFv2.WebACL.AndStatementTwo')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.WebACL.AndStatementTwo'
