function Add-VSWAFv2RuleGroupNotStatementTwo {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::RuleGroup.NotStatementTwo resource property to the template. Logical NOT statement used to negate the match results of a nested statement.
...
Logical NOT statement used to negate the match results of a nested statement.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.WAFv2.RuleGroup.NotStatementTwo')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.RuleGroup.NotStatementTwo'
