function Add-SAMDynamoDBEventSource {
    <#
    .SYNOPSIS
    ...
    .FUNCTIONALITY
        Serverless
    #>
    [OutputType('Vaporshell.Serverless.EventSource.DynamoDB')]
    [cmdletbinding()]
    Param
    (
    ...
    Add-SAMEventSource @Params | Add-ObjectDetail -TypeName 'Vaporshell.Serverless.EventSource.DynamoDB'
}