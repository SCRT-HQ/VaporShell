function Add-VSIoTTopicRuleDynamoDBAction {
    ...
    .PARAMETER HashKeyType
		Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iot-dynamodb.html#cfn-iot-dynamodb-hashkeytype    
		PrimitiveType: String    
		Required: False    
		UpdateType: Mutable    
    ...
    .PARAMETER RangeKeyType
		Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iot-dynamodb.html#cfn-iot-dynamodb-rangeKeytype    
		PrimitiveType: String    
		Required: False    
		UpdateType: Mutable    
