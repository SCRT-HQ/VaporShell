function New-ApiGatewayClientCertificate {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
        ...
        $templateInit.AddResource((New-ApiGatewayClientCertificate -LogicalId "ClientCertificate" -Description "A test client certificate"))
