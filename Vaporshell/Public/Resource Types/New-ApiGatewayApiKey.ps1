function New-ApiGatewayApiKey {
    ...
    .PARAMETER StageKeys
        ...
        You must use the Add-APIGatewayApiKeyStageKey function to add in the StageKeys
    ...
    .EXAMPLE
        $templateInit = Initialize-Vaporshell -Description "Testing New-ApiGatewayApiKey"
        $templateInit.AddResource(
            (
                New-ApiGatewayApiKey -LogicalId "GatewayApiKey" -Description "Test key" -Enabled True -Name "Test key" -StageKeys (Add-APIGatewayApiKeyStageKey -RestApiId (Add-FnRef -Ref "RestApi") -StageName "TestPhase")
            )
        )
...
```json
{
    ...
    "Description": "Testing New-ApiGatewayApiKey",
    "Resources": {
        "GatewayApiKey": {
    ...
    Process {
        switch ($PSBoundParameters.Keys) {
            ...
            'Enabled' {
                ...
                $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name 'Enabled' -Value $(($Enabled).ToLower())
            }
            'Name' {
                if (!($ResourceParams["Properties"])) {
                    $ResourceParams.Add("Properties",([PSCustomObject]@{}))
