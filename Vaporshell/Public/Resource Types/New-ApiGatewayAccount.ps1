function New-ApiGatewayAccount {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
        $templateInit = Initialize-Vaporshell -Description "Testing New-ApiGatewayAccount"
        $templateInit.AddResource((New-ApiGatewayAccount -LogicalId "GatewayAccount" -CloudWatchRoleArn "ARN::Gateway::IAM"))

        When the template is exported, this will convert to: 
```json
{
    "AWSTemplateFormatVersion": "2010-09-09",
    "Description": "Testing New-ApiGatewayAccount",
    "Resources": {
        "GatewayAccount": {
            "Type": "AWS::ApiGateway::Account",
            "Properties": {
                "CloudWatchRoleArn": "ARN::Gateway::IAM"
            }
        }
    }
}
````
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ApiGateway','Vaporshell.Resource.ApiGateway.Account'
