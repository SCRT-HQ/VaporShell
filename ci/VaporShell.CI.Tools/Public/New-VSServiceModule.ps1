function New-VSServiceModule {
    ...
    Begin {
        ...
        $serviceModuleTemplate = [System.IO.Path]::Combine($repoRoot,'ServiceModuleTemplate')
        $serviceModulePath = [System.IO.Path]::Combine($repoRoot,'ServiceModules')
        $autoGenPath = [System.IO.Path]::Combine($repoRoot,'BuildOutput','_autoGenerated')
    ...
    Process {
        ...
        $null = Copy-Item $modulePath -Destination $autoGenPath -Container -Force -Recurse
    }
}
