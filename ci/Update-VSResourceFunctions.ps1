function Update-VSResourceFunctions {
    ...
    $VaporshellPath = [System.IO.Path]::Combine($PSScriptRoot,"..","VaporShell")
    $BeforeTypeCount = (Get-ChildItem -Path (Resolve-Path "$VaporshellPath\Public\Resource Types").Path).Count
    $BeforePropCount = (Get-ChildItem -Path (Resolve-Path "$VaporshellPath\Public\Resource Property Types").Path).Count
    $regHash = @{
    ...
    $AfterTypeCount = (Get-ChildItem -Path (Resolve-Path "$VaporshellPath\Public\Resource Types").Path).Count
    $AfterPropCount = (Get-ChildItem -Path (Resolve-Path "$VaporshellPath\Public\Resource Property Types").Path).Count
