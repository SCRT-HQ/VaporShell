...
```
New-VSDLMLifecyclePolicy [-LogicalId] <String> [-ExecutionRoleArn <Object>] [-Description <Object>]
 [-State <Object>] [-PolicyDetails <Object>] [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
...
### Vaporshell.Resource.DLM.LifecyclePolicy
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dlm-lifecyclepolicy.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dlm-lifecyclepolicy.html)
