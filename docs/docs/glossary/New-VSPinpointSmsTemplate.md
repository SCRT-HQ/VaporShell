# New-VSPinpointSmsTemplate

## SYNOPSIS
Adds an AWS::Pinpoint::SmsTemplate resource to the template.
The AWS::Pinpoint::SmsTemplate resource is a message template that you can use in messages that are sent through the SMS channel.
...
```
New-VSPinpointSmsTemplate [-LogicalId] <String> -TemplateName <Object> [-TemplateDescription <Object>]
 [-DefaultSubstitutions <Object>] -Body <Object> [-Tags <Object>] [-DeletionPolicy <String>]
...
### Vaporshell.Resource.Pinpoint.SmsTemplate
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-smstemplate.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-smstemplate.html)
