...
```
Add-VSWAFv2RuleGroupStatementTwo [[-ByteMatchStatement] <Object>] [[-SqliMatchStatement] <Object>]
...
### Vaporshell.Resource.WAFv2.RuleGroup.StatementTwo
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-statementtwo.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-statementtwo.html)
