...
```
New-VSEC2TrafficMirrorTarget [-LogicalId] <String> [-NetworkLoadBalancerArn <Object>] [-Description <Object>]
 [-NetworkInterfaceId <Object>] [-Tags <Object>] [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
...
The Traffic Mirror source and the Traffic Mirror target (monitoring appliances can be in the same VPC, or in different VPCs connected via VPC peering or a transit gateway.
...
### Vaporshell.Resource.EC2.TrafficMirrorTarget
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-trafficmirrortarget.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-trafficmirrortarget.html)
