# New-VSDetectiveMemberInvitation

## SYNOPSIS
Adds an AWS::Detective::MemberInvitation resource to the template.
The AWS::Detective::MemberInvitation resource is an Amazon Detective resource type that sends an invitation to join a Detective behavior graph.
The invitation is sent from the master account to the root user email address of an AWS account.

## SYNTAX

```
New-VSDetectiveMemberInvitation [-LogicalId] <String> -GraphArn <Object> -MemberId <Object>
 -MemberEmailAddress <Object> [-Message <Object>] [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
...
### Vaporshell.Resource.Detective.MemberInvitation
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-detective-memberinvitation.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-detective-memberinvitation.html)
