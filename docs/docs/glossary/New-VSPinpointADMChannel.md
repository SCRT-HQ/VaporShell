...
Before you can use Amazon Pinpoint to send messages to Amazon devices, you have to enable the ADM channel for an Amazon Pinpoint application.

## SYNTAX

```
New-VSPinpointADMChannel [-LogicalId] <String> -ClientSecret <Object> [-Enabled <Object>] -ClientId <Object>
