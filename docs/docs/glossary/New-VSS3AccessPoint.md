...
```
New-VSS3AccessPoint [-LogicalId] <String> [-Name <Object>] -Bucket <Object> [-VpcConfiguration <Object>]
 [-PublicAccessBlockConfiguration <Object>] [-Policy <Object>] [-PolicyStatus <Object>]
 [-NetworkOrigin <Object>] [-CreationDate <Object>] [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
...
If VpcConfiguration is specified for this access point, then NetworkOrigin is VPC, and the access point doesn't allow access from the internet.
Otherwise, NetworkOrigin is Internet, and the access point allows access from the internet, subject to the access point and bucket access policies.
...
### Vaporshell.Resource.S3.AccessPoint
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-s3-accesspoint.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-s3-accesspoint.html)
