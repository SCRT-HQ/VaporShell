...
```
New-VSAppMeshVirtualService [-LogicalId] <String> -MeshName <Object> [-MeshOwner <Object>]
 -VirtualServiceName <Object> -Spec <Object> [-Tags <Object>] [-DeletionPolicy <String>]
