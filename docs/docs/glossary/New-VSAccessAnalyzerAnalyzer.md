...
The analyzer is an object that represents the IAM Access Analyzer feature.
An analyzer is required for Access Analyzer to become operational.

## SYNTAX

```
New-VSAccessAnalyzerAnalyzer [-LogicalId] <String> [-AnalyzerName <Object>] [-ArchiveRules <Object>]
 [-Tags <Object>] -Type <Object> [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
...
### Vaporshell.Resource.AccessAnalyzer.Analyzer
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-accessanalyzer-analyzer.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-accessanalyzer-analyzer.html)
