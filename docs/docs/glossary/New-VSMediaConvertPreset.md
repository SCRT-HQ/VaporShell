...
```
New-VSMediaConvertPreset [-LogicalId] <String> [-Category <Object>] [-Description <Object>]
 -SettingsJson <Object> [-Tags <Object>] [-Name <Object>] [-DeletionPolicy <String>]
...
For more information about creating an output preset model for the SettingsJson property, see the Remarks section later in this topic.
...
### Vaporshell.Resource.MediaConvert.Preset
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-mediaconvert-preset.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-mediaconvert-preset.html)
