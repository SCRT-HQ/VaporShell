...
```
New-VSKinesisAnalyticsV2Application [-LogicalId] <String> [-ApplicationName <Object>]
 -RuntimeEnvironment <Object> [-ApplicationConfiguration <Object>] [-ApplicationDescription <Object>]
 [-Tags <Object>] -ServiceExecutionRole <Object> [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
...
A tag is a key-value pair that identifies an application.
...
### Vaporshell.Resource.KinesisAnalyticsV2.Application
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-kinesisanalyticsv2-application.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-kinesisanalyticsv2-application.html)
