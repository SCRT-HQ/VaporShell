# New-VSChatbotSlackChannelConfiguration
...
```
New-VSChatbotSlackChannelConfiguration [-LogicalId] <String> -SlackWorkspaceId <Object>
 -SlackChannelId <Object> -ConfigurationName <Object> -IamRoleArn <Object> [-SnsTopicArns <Object>]
 [-LoggingLevel <Object>] [-Arn <Object>] [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
...
This resource requires some setup to be done in the AWS Chatbot console.
To provide the required Slack workspace ID, you must perform the initial authorization flow with Slack in the AWS Chatbot console, then copy and paste the workspace ID from the console.
...
### Vaporshell.Resource.Chatbot.SlackChannelConfiguration
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-chatbot-slackchannelconfiguration.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-chatbot-slackchannelconfiguration.html)
