...
```
New-VSRoboMakerRobotApplicationVersion [-LogicalId] <String> [-CurrentRevisionId <Object>]
...
### Vaporshell.Resource.RoboMaker.RobotApplicationVersion
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-robomaker-robotapplicationversion.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-robomaker-robotapplicationversion.html)
