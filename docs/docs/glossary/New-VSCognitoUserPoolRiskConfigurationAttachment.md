...
```
New-VSCognitoUserPoolRiskConfigurationAttachment [-LogicalId] <String>
 [-CompromisedCredentialsRiskConfiguration <Object>] -UserPoolId <Object> -ClientId <Object>
 [-AccountTakeoverRiskConfiguration <Object>] [-RiskExceptionConfiguration <Object>] [-DeletionPolicy <String>]
...
You can specify risk configuration for a single client (with a specific clientId or for all clients (by setting the clientId to ALL.
If you specify ALL, the default configuration is used for every client that has had no risk configuration set previously.
If you specify risk configuration for a particular client, it no longer falls back to the ALL configuration.
...
### Vaporshell.Resource.Cognito.UserPoolRiskConfigurationAttachment
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cognito-userpoolriskconfigurationattachment.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cognito-userpoolriskconfigurationattachment.html)
