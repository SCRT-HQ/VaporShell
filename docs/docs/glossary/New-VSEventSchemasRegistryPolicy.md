# New-VSEventSchemasRegistryPolicy
...
```
New-VSEventSchemasRegistryPolicy [-LogicalId] <String> -Policy <Object> -RegistryName <Object>
 [-RevisionId <Object>] [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>] [-DependsOn <String[]>]
...
### Vaporshell.Resource.EventSchemas.RegistryPolicy
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-eventschemas-registrypolicy.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-eventschemas-registrypolicy.html)
