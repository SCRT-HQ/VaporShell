# New-VSNetworkManagerGlobalNetwork
...
```
New-VSNetworkManagerGlobalNetwork [-LogicalId] <String> [-Description <Object>] [-Tags <Object>]
...
### Vaporshell.Resource.NetworkManager.GlobalNetwork
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-networkmanager-globalnetwork.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-networkmanager-globalnetwork.html)
