...
Using a workflow, you can design a complex multi-job extract, transform, and load (ETL activity that AWS Glue can execute and track as single entity

## SYNTAX

```
New-VSGlueWorkflow [-LogicalId] <String> [-Description <Object>] [-DefaultRunProperties <Object>]
...
### Vaporshell.Resource.Glue.Workflow
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-glue-workflow.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-glue-workflow.html)
