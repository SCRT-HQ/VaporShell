...
```
New-VSEC2VPCEndpointServicePermissions [-LogicalId] <String> [-AllowedPrincipals <Object>] -ServiceId <Object>
...
Permissions are revoked for principals not in this list.
...
### Vaporshell.Resource.EC2.VPCEndpointServicePermissions
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpcendpointservicepermissions.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpcendpointservicepermissions.html)
