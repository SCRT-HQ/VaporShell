...
```
New-VSRAMResourceShare [-LogicalId] <String> [-Principals <Object>] [-AllowExternalPrincipals <Object>]
 [-ResourceArns <Object>] [-Tags <Object>] -Name <Object> [-DeletionPolicy <String>]
