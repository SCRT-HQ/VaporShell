...
```
New-VSManagedBlockchainNode [-LogicalId] <String> -MemberId <Object> -NetworkId <Object>
 -NodeConfiguration <Object> [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>] [-DependsOn <String[]>]
...
### Vaporshell.Resource.ManagedBlockchain.Node
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-managedblockchain-node.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-managedblockchain-node.html)
