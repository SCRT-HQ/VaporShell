...
```
New-VSCognitoUserPoolIdentityProvider [-LogicalId] <String> -ProviderName <Object> -UserPoolId <Object>
 [-AttributeMapping <Object>] [-ProviderDetails <Object>] -ProviderType <Object> [-IdpIdentifiers <Object>]
...
### Vaporshell.Resource.Cognito.UserPoolIdentityProvider
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cognito-userpoolidentityprovider.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cognito-userpoolidentityprovider.html)
