...
For more information about queues, see Working with AWS Elemental MediaConvert Queues: https://docs.aws.amazon.com/mediaconvert/latest/ug/working-with-queues.html in the *AWS Elemental MediaConvert User Guide*.

## SYNTAX

```
New-VSMediaConvertQueue [-LogicalId] <String> [-Status <Object>] [-Description <Object>]
 [-PricingPlan <Object>] [-Tags <Object>] [-Name <Object>] [-DeletionPolicy <String>]
...
Queues can be either ACTIVE or PAUSED.
If you create a paused queue, then jobs that you send to that queue won't begin.
...
To create a reserved queue, use the AWS Elemental MediaConvert console at https://console.aws.amazon.com/mediaconvert to set up a contract.
...
### Vaporshell.Resource.MediaConvert.Queue
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-mediaconvert-queue.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-mediaconvert-queue.html)
