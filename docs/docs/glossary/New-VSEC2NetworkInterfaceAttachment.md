...
```
New-VSEC2NetworkInterfaceAttachment [-LogicalId] <String> [-DeleteOnTermination <Object>] -DeviceIndex <Object>
 -InstanceId <Object> -NetworkInterfaceId <Object> [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
