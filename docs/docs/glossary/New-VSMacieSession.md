...
```
New-VSMacieSession [-LogicalId] <String> [-Status <Object>] [-FindingPublishingFrequency <Object>]
...
### Vaporshell.Resource.Macie.Session
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-macie-session.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-macie-session.html)
