...
```
New-VSAppMeshRoute [-LogicalId] <String> -MeshName <Object> -VirtualRouterName <Object> [-MeshOwner <Object>]
 -RouteName <Object> -Spec <Object> [-Tags <Object>] [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
