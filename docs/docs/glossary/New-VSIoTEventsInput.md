# New-VSIoTEventsInput

## SYNOPSIS
Adds an AWS::IoTEvents::Input resource to the template.
The AWS::IoTEvents::Input resource creates an input.
To monitor your devices and processes, they must have a way to get telemetry data into AWS IoT Events.
This is done by sending messages as *inputs* to AWS IoT Events.
...
```
New-VSIoTEventsInput [-LogicalId] <String> [-InputDefinition <Object>] [-InputName <Object>]
 [-InputDescription <Object>] [-Tags <Object>] [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
...
### Vaporshell.Resource.IoTEvents.Input
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iotevents-input.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iotevents-input.html)
