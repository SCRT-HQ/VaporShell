...
An API mapping relates a path of your custom domain name to a stage of your API.
...
New-VSApiGatewayV2ApiMapping [-LogicalId] <String> -DomainName <Object> -Stage <Object>
 [-ApiMappingKey <Object>] -ApiId <Object> [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
