# New-VSImageBuilderImagePipeline
...
The Image Builder image pipeline is associated with an image recipe that defines the build, validation, and test phases for an image build lifecycle.
...
You can also associate your image pipeline with a distribution configuration to define how you would like to deploy your image.

## SYNTAX

```
New-VSImageBuilderImagePipeline [-LogicalId] <String> -Name <Object> [-Description <Object>]
 [-ImageTestsConfiguration <Object>] [-Status <Object>] [-Schedule <Object>] -ImageRecipeArn <Object>
 [-DistributionConfigurationArn <Object>] -InfrastructureConfigurationArn <Object> [-Tags <Hashtable>]
...
### Vaporshell.Resource.ImageBuilder.ImagePipeline
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-imagebuilder-imagepipeline.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-imagebuilder-imagepipeline.html)
