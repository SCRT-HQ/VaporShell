...
```
New-VSWAFRegionalIPSet [-LogicalId] <String> [-IPSetDescriptors <Object>] -Name <Object>
...
To specify an individual IP address, you specify the four-part IP address followed by a /32, for example, 192.0.2.0/32.
...
### Vaporshell.Resource.WAFRegional.IPSet
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafregional-ipset.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafregional-ipset.html)
