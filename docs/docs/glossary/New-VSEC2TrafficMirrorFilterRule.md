# New-VSEC2TrafficMirrorFilterRule
...
```
New-VSEC2TrafficMirrorFilterRule [-LogicalId] <String> [-DestinationPortRange <Object>] [-Description <Object>]
 [-SourcePortRange <Object>] -RuleAction <Object> -SourceCidrBlock <Object> -RuleNumber <Object>
 -DestinationCidrBlock <Object> -TrafficMirrorFilterId <Object> -TrafficDirection <Object> [-Protocol <Object>]
...
### Vaporshell.Resource.EC2.TrafficMirrorFilterRule
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-trafficmirrorfilterrule.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-trafficmirrorfilterrule.html)
