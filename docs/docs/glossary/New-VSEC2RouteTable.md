...
```
New-VSEC2RouteTable [-LogicalId] <String> [-Tags <Object>] -VpcId <Object> [-DeletionPolicy <String>]
...
### Vaporshell.Resource.EC2.RouteTable
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-route-table.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-route-table.html)
