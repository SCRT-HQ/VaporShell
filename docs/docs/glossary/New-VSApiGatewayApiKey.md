...
```
New-VSApiGatewayApiKey [-LogicalId] <String> [-CustomerId <Object>] [-Description <Object>] [-Enabled <Object>]
 [-GenerateDistinctId <Object>] [-Name <Object>] [-StageKeys <Object>] [-Tags <Object>] [-Value <Object>]
