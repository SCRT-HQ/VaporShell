...
```
New-VSEC2VPNConnection [-LogicalId] <String> -CustomerGatewayId <Object> [-StaticRoutesOnly <Object>]
 [-Tags <Object>] [-TransitGatewayId <Object>] -Type <Object> [-VpnGatewayId <Object>]
 [-VpnTunnelOptionsSpecifications <Object>] [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
