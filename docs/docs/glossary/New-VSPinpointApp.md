...
The AWS::Pinpoint::App resource is an Amazon Pinpoint application, also referred to as a *project* or *app*.
...
```
New-VSPinpointApp [-LogicalId] <String> [-Tags <Object>] -Name <Object> [-DeletionPolicy <String>]
...
This name is displayed as the **Project name** on the Amazon Pinpoint console.
