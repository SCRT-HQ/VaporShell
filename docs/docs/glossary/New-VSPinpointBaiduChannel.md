...
Before you can use Amazon Pinpoint to send notifications to the Baidu Cloud Push service, you have to enable the Baidu channel for an Amazon Pinpoint application.

## SYNTAX

```
New-VSPinpointBaiduChannel [-LogicalId] <String> -SecretKey <Object> -ApiKey <Object> [-Enabled <Object>]
