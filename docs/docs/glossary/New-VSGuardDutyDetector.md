...
```
New-VSGuardDutyDetector [-LogicalId] <String> [-FindingPublishingFrequency <Object>] -Enable <Object>
...
Valid values include: FIFTEEN_MINUTES | ONE_HOUR | SIX_HOURS.
The default value is SIX_HOURS.
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-guardduty-detector.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-guardduty-detector.html)
