...
```
New-VSAppMeshMesh [-LogicalId] <String> -MeshName <Object> [-Spec <Object>] [-Tags <Object>]
...
### Vaporshell.Resource.AppMesh.Mesh
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appmesh-mesh.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appmesh-mesh.html)
