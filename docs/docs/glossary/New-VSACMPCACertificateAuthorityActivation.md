# New-VSACMPCACertificateAuthorityActivation
...
If no status is specified, the AWS::ACMPCA::CertificateAuthorityActivation resource status defaults to ACTIVE.
Once the CA has a CA certificate installed, you can use the resource to toggle the CA status field between ACTIVE and DISABLED.

## SYNTAX

```
New-VSACMPCACertificateAuthorityActivation [-LogicalId] <String> -CertificateAuthorityArn <Object>
 -Certificate <Object> [-CertificateChain <Object>] [-Status <Object>] [-DeletionPolicy <String>]
...
### Vaporshell.Resource.ACMPCA.CertificateAuthorityActivation
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-acmpca-certificateauthorityactivation.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-acmpca-certificateauthorityactivation.html)
