# New-VSAppStreamStackUserAssociation
...
```
New-VSAppStreamStackUserAssociation [-LogicalId] <String> [-SendEmailNotification <Object>] -UserName <Object>
 -StackName <Object> -AuthenticationType <Object> [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
