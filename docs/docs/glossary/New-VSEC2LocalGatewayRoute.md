...
```
New-VSEC2LocalGatewayRoute [-LogicalId] <String> -DestinationCidrBlock <Object>
 -LocalGatewayRouteTableId <Object> -LocalGatewayVirtualInterfaceGroupId <Object> [-DeletionPolicy <String>]
...
### Vaporshell.Resource.EC2.LocalGatewayRoute
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-localgatewayroute.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-localgatewayroute.html)
