...
```
New-VSNetworkManagerDevice [-LogicalId] <String> [-Description <Object>] [-Tags <Object>]
 -GlobalNetworkId <Object> [-Location <Object>] [-Model <Object>] [-SerialNumber <Object>] [-SiteId <Object>]
 [-Type <Object>] [-Vendor <Object>] [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
...
### Vaporshell.Resource.NetworkManager.Device
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-networkmanager-device.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-networkmanager-device.html)
