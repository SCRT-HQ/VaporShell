...
```
New-VSSESReceiptRule [-LogicalId] <String> [-After <Object>] -Rule <Object> -RuleSetName <Object>
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ses-receiptrule.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ses-receiptrule.html)
