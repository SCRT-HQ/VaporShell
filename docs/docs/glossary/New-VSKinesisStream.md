...
```
New-VSKinesisStream [-LogicalId] <String> [-Name <Object>] [-RetentionPeriodHours <Object>]
 -ShardCount <Object> [-StreamEncryption <Object>] [-Tags <Object>] [-DeletionPolicy <String>]
