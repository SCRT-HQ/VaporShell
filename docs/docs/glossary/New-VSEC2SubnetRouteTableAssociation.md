...
If you want to associate a route table with a VPC, see  AWS::EC2::RouteTable: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-route-table.html.

## SYNTAX

```
New-VSEC2SubnetRouteTableAssociation [-LogicalId] <String> -RouteTableId <Object> -SubnetId <Object>
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-subnet-route-table-assoc.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-subnet-route-table-assoc.html)
