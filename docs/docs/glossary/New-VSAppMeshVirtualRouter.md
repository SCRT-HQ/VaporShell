...
```
New-VSAppMeshVirtualRouter [-LogicalId] <String> -MeshName <Object> -VirtualRouterName <Object>
 [-MeshOwner <Object>] -Spec <Object> [-Tags <Object>] [-DeletionPolicy <String>]
...
After you create your virtual router, create and associate routes for your virtual router that direct incoming requests to different virtual nodes.
...
If the account ID is not your own, then the account that you specify must share the mesh with your account before you can create the resource in the service mesh.
...
### Vaporshell.Resource.AppMesh.VirtualRouter
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appmesh-virtualrouter.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appmesh-virtualrouter.html)
