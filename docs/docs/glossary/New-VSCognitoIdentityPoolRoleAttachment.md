...
New-VSCognitoIdentityPoolRoleAttachment [-LogicalId] <String> [-RoleMappings <Object>] -IdentityPoolId <Object>
 [-Roles <Object>] [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>] [-DependsOn <String[]>]
...
This is a string to the RoleMapping object map.
The string identifies the identity provider.
...
For a given role, the key is either "authenticated" or "unauthenticated".
The value is the role ARN.
