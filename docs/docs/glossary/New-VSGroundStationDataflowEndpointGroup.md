...
```
New-VSGroundStationDataflowEndpointGroup [-LogicalId] <String> -EndpointDetails <Object> [-Tags <Object>]
...
### Vaporshell.Resource.GroundStation.DataflowEndpointGroup
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-groundstation-dataflowendpointgroup.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-groundstation-dataflowendpointgroup.html)
