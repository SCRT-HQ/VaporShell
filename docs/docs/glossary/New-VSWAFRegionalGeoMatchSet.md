...
```
New-VSWAFRegionalGeoMatchSet [-LogicalId] <String> [-GeoMatchConstraints <Object>] -Name <Object>
...
### -Name
A friendly name or description of the AWS::WAFRegional::GeoMatchSet: #aws-resource-wafregional-geomatchset.
...
### Vaporshell.Resource.WAFRegional.GeoMatchSet
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafregional-geomatchset.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafregional-geomatchset.html)
