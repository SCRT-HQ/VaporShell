...
```
New-VSEC2TransitGatewayRoute [-LogicalId] <String> -TransitGatewayRouteTableId <Object>
 [-DestinationCidrBlock <Object>] [-Blackhole <Boolean>] [-TransitGatewayAttachmentId <Object>]
...
### Vaporshell.Resource.EC2.TransitGatewayRoute
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-transitgatewayroute.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-transitgatewayroute.html)
