...
```
New-VSImageBuilderDistributionConfiguration [-LogicalId] <String> -Name <Object> [-Description <Object>]
 -Distributions <Object> [-Tags <Hashtable>] [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
...
### Vaporshell.Resource.ImageBuilder.DistributionConfiguration
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-imagebuilder-distributionconfiguration.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-imagebuilder-distributionconfiguration.html)
