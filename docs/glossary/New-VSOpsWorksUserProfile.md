...
```
New-VSOpsWorksUserProfile [-LogicalId] <String> [-AllowSelfManagement <Object>] -IamUserArn <Object>
 [-SshPublicKey <Object>] [-SshUsername <Object>] [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
