...
```
New-VSSQSQueuePolicy [-LogicalId] <String> -PolicyDocument <Object> -Queues <Object> [-DeletionPolicy <String>]
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sqs-policy.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sqs-policy.html)
