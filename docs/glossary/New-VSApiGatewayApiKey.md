...
online version: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apigateway-apikey.html
schema: 2.0.0
---
...
```
New-VSApiGatewayApiKey [-LogicalId] <String> [-Description <Object>] [-Enabled <Boolean>] [-Name <Object>]
 [-StageKeys <Object>] [-DeletionPolicy <String>] [-DependsOn <String[]>] [-Metadata <Object>]
