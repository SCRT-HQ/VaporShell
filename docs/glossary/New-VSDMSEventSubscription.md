...
New-VSDMSEventSubscription [-LogicalId] <String> [-SourceType <Object>] [-EventCategories <Object>]
 [-Enabled <Object>] [-SubscriptionName <Object>] -SnsTopicArn <Object> [-SourceIds <Object>] [-Tags <Object>]
...
For example, if you specify a database instance ID, then all of the other values must be database instance IDs.
