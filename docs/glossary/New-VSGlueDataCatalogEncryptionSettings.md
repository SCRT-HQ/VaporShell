# New-VSGlueDataCatalogEncryptionSettings
...
```
New-VSGlueDataCatalogEncryptionSettings [-LogicalId] <String> -DataCatalogEncryptionSettings <Object>
 -CatalogId <Object> [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>] [-DependsOn <String[]>]
...
### Vaporshell.Resource.Glue.DataCatalogEncryptionSettings
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-glue-datacatalogencryptionsettings.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-glue-datacatalogencryptionsettings.html)
