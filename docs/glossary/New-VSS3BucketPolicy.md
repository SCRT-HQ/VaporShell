...
```
New-VSS3BucketPolicy [-LogicalId] <String> -Bucket <Object> -PolicyDocument <Object> [-DeletionPolicy <String>]
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-policy.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-policy.html)
