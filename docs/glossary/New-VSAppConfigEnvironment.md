...
You define one or more environments for each AppConfig application.
You can also define environments for application subcomponents such as the Web, Mobile and Back-end components for your application.
...
```
New-VSAppConfigEnvironment [-LogicalId] <String> [-Description <Object>] [-Monitors <Object>]
 -ApplicationId <Object> [-Tags <Object>] -Name <Object> [-DeletionPolicy <String>]
...
### Vaporshell.Resource.AppConfig.Environment
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appconfig-environment.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appconfig-environment.html)
