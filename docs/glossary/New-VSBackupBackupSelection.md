...
```
New-VSBackupBackupSelection [-LogicalId] <String> -BackupSelection <Object> -BackupPlanId <Object>
...
### Vaporshell.Resource.Backup.BackupSelection
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-backup-backupselection.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-backup-backupselection.html)
