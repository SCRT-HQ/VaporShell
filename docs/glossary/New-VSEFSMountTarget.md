...
online version: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-efs-mounttarget.html
schema: 2.0.0
---
...
```
New-VSEFSMountTarget [-LogicalId] <String> -FileSystemId <Object> [-IpAddress <Object>]
 -SecurityGroups <Object> -SubnetId <Object> [-DeletionPolicy <String>] [-DependsOn <String[]>]
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-efs-mounttarget.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-efs-mounttarget.html)
