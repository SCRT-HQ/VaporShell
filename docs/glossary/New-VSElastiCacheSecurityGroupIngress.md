...
online version: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticache-security-group-ingress.html
schema: 2.0.0
---
...
```
New-VSElastiCacheSecurityGroupIngress [-LogicalId] <String> -CacheSecurityGroupName <Object>
 -EC2SecurityGroupName <Object> [-EC2SecurityGroupOwnerId <Object>] [-DeletionPolicy <String>]
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticache-security-group-ingress.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticache-security-group-ingress.html)
