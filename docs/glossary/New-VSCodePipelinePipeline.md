...
New-VSCodePipelinePipeline [-LogicalId] <String> [-ArtifactStore <Object>] [-ArtifactStores <Object>]
 [-DisableInboundStageTransitions <Object>] [-Name <Object>] [-RestartExecutionOnUpdate <Object>]
 -RoleArn <Object> -Stages <Object> [-Tags <Object>] [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
