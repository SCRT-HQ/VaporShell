# New-VSApiGatewayV2RouteResponse
...
```
New-VSApiGatewayV2RouteResponse [-LogicalId] <String> -RouteResponseKey <Object> [-ResponseParameters <Object>]
 -RouteId <Object> [-ModelSelectionExpression <Object>] -ApiId <Object> [-ResponseModels <Object>]
...
### Vaporshell.Resource.ApiGatewayV2.RouteResponse
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apigatewayv2-routeresponse.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apigatewayv2-routeresponse.html)
