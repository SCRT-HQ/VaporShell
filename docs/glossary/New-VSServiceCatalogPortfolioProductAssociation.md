---
layout: glossary
title: New-VSServiceCatalogPortfolioProductAssociation
categories: glossary
label1: Category
data1: Documentation
label2: Depth
...
```
New-VSServiceCatalogPortfolioProductAssociation [-LogicalId] <String> [-SourcePortfolioId <Object>]
 [-AcceptLanguage <Object>] -PortfolioId <Object> -ProductId <Object> [-DeletionPolicy <String>]
...
### Vaporshell.Resource.ServiceCatalog.PortfolioProductAssociation

## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-servicecatalog-portfolioproductassociation.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-servicecatalog-portfolioproductassociation.html)
