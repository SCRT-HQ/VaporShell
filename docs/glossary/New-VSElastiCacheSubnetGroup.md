...
online version: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticache-subnetgroup.html
schema: 2.0.0
---
...
```
New-VSElastiCacheSubnetGroup [-LogicalId] <String> [-CacheSubnetGroupName <Object>] -Description <Object>
 -SubnetIds <Object> [-DeletionPolicy <String>] [-DependsOn <String[]>] [-Metadata <Object>]
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticache-subnetgroup.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticache-subnetgroup.html)
