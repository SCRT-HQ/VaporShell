...
```
Add-VSKinesisAnalyticsV2ApplicationCSVMappingParameters [-RecordRowDelimiter] <Object>
...
### Vaporshell.Resource.KinesisAnalyticsV2.Application.CSVMappingParameters
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisanalyticsv2-application-csvmappingparameters.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisanalyticsv2-application-csvmappingparameters.html)
