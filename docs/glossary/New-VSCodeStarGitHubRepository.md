...
```
New-VSCodeStarGitHubRepository [-LogicalId] <String> [-EnableIssues <Boolean>] -RepositoryName <Object>
 -RepositoryAccessToken <Object> -RepositoryOwner <Object> [-IsPrivate <Boolean>] [-Code <Object>]
