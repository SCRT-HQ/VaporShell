...
online version: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-kms-key.html
schema: 2.0.0
---
...
New-VSKMSKey [-LogicalId] <String> [-Description <Object>] [-EnableKeyRotation <Boolean>] [-Enabled <Boolean>]
 -KeyPolicy <Object> [-KeyUsage <Object>] [-DeletionPolicy <String>] [-DependsOn <String[]>]
