...
```
New-VSEC2VPCCidrBlock [-LogicalId] <String> [-AmazonProvidedIpv6CidrBlock <Object>] [-CidrBlock <Object>]
 -VpcId <Object> [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>] [-DependsOn <String[]>]
