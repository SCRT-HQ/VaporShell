...
```
New-VSEC2NetworkAclEntry [-LogicalId] <String> [-CidrBlock <Object>] [-Egress <Object>] [-Icmp <Object>]
 [-Ipv6CidrBlock <Object>] -NetworkAclId <Object> [-PortRange <Object>] -Protocol <Object> -RuleAction <Object>
 -RuleNumber <Object> [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>] [-DependsOn <String[]>]
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-network-acl-entry.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-network-acl-entry.html)
