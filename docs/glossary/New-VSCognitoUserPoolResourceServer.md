...
```
New-VSCognitoUserPoolResourceServer [-LogicalId] <String> -UserPoolId <Object> -Identifier <Object>
 [-Scopes <Object>] -Name <Object> [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
...
### -Scopes
The scopes.
Each scope is a map, where the keys are name and the values are description for the scope.
...
### Vaporshell.Resource.Cognito.UserPoolResourceServer
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cognito-userpoolresourceserver.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cognito-userpoolresourceserver.html)
