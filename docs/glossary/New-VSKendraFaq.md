...
```
New-VSKendraFaq [-LogicalId] <String> -IndexId <Object> -Name <Object> [-Description <Object>] -S3Path <Object>
 -RoleArn <Object> [-Tags <Object>] [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
