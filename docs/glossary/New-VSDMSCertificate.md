...
```
New-VSDMSCertificate [-LogicalId] <String> [-CertificateIdentifier <Object>] [-CertificatePem <Object>]
 [-CertificateWallet <Object>] [-DeletionPolicy <String>] [-DependsOn <String[]>] [-Metadata <Object>]
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dms-certificate.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dms-certificate.html)
