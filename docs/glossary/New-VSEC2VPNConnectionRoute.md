...
```
New-VSEC2VPNConnectionRoute [-LogicalId] <String> -DestinationCidrBlock <Object> -VpnConnectionId <Object>
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpn-connection-route.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpn-connection-route.html)
