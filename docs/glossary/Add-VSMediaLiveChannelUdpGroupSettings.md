...
```
Add-VSMediaLiveChannelUdpGroupSettings [[-TimedMetadataId3Frame] <Object>] [[-TimedMetadataId3Period] <Object>]
 [[-InputLossAction] <Object>] [<CommonParameters>]
```
...
### Vaporshell.Resource.MediaLive.Channel.UdpGroupSettings
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-medialive-channel-udpgroupsettings.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-medialive-channel-udpgroupsettings.html)
