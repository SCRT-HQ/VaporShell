...
```
New-VSMediaPackagePackagingConfiguration [-LogicalId] <String> -Id <Object> -PackagingGroupId <Object>
 [-CmafPackage <Object>] [-DashPackage <Object>] [-HlsPackage <Object>] [-MssPackage <Object>] [-Tags <Object>]
...
### Vaporshell.Resource.MediaPackage.PackagingConfiguration
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-mediapackage-packagingconfiguration.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-mediapackage-packagingconfiguration.html)
