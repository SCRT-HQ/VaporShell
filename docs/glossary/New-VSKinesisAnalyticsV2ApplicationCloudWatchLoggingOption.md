...
```
New-VSKinesisAnalyticsV2ApplicationCloudWatchLoggingOption [-LogicalId] <String> -ApplicationName <Object>
 -CloudWatchLoggingOption <Object> [-DeletionPolicy <String>] [-DependsOn <String[]>] [-Metadata <Object>]
...
### Vaporshell.Resource.KinesisAnalyticsV2.ApplicationCloudWatchLoggingOption
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-kinesisanalyticsv2-applicationcloudwatchloggingoption.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-kinesisanalyticsv2-applicationcloudwatchloggingoption.html)
