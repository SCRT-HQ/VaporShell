...
```
New-VSRDSOptionGroup [-LogicalId] <String> -EngineName <Object> -MajorEngineVersion <Object>
 -OptionConfigurations <Object> -OptionGroupDescription <Object> [-Tags <Object>] [-DeletionPolicy <String>]
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-rds-optiongroup.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-rds-optiongroup.html)
