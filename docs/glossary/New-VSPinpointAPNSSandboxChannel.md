...
Before you use Amazon Pinpoint to send notifications to the APNs sandbox environment, you have to enable the APNs sandbox channel for an Amazon Pinpoint app.
...
The APNs Sandbox Channel resource represents the status and authentication settings of the APNs sandbox channel for a specific application.
You can use this resource to retrieve information about, update, or disable (delete the APNs sandbox channel for an application.
