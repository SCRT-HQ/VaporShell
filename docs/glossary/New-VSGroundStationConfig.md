...
```
New-VSGroundStationConfig [-LogicalId] <String> -Name <Object> [-Tags <Object>] -ConfigData <Object>
...
### Vaporshell.Resource.GroundStation.Config
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-groundstation-config.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-groundstation-config.html)
