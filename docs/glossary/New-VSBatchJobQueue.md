...
```
New-VSBatchJobQueue [-LogicalId] <String> -ComputeEnvironmentOrder <Object> -Priority <Object>
 [-State <Object>] [-JobQueueName <Object>] [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
