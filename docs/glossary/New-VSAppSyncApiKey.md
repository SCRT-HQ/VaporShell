...
```
New-VSAppSyncApiKey [-LogicalId] <String> [-Description <Object>] [-Expires <Double>] -ApiId <Object>
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appsync-apikey.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appsync-apikey.html)
