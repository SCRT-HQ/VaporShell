...
```
New-VSEC2TrafficMirrorFilter [-LogicalId] <String> [-Description <Object>] [-NetworkServices <Object>]
...
To mirror traffic, use AWS::EC2::TrafficMirrorFilterRule: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-trafficmirrorfilterrule.html to add Traffic Mirror rules to the filter.
...
### Vaporshell.Resource.EC2.TrafficMirrorFilter
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-trafficmirrorfilter.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-trafficmirrorfilter.html)
