...
online version: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-logs-subscriptionfilter.html
schema: 2.0.0
---
...
```
New-VSLogsSubscriptionFilter [-LogicalId] <String> -DestinationArn <Object> -FilterPattern <Object>
 -LogGroupName <Object> [-RoleArn <Object>] [-DeletionPolicy <String>] [-DependsOn <String[]>]
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-logs-subscriptionfilter.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-logs-subscriptionfilter.html)
