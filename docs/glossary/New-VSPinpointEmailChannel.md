# New-VSPinpointEmailChannel

## SYNOPSIS
Adds an AWS::Pinpoint::EmailChannel resource to the template.
A *channel* is a type of platform that you can deliver messages to.
You can use the email channel to send email to users.
Before you can use Amazon Pinpoint to send email, you must enable the email channel for an Amazon Pinpoint application.

## SYNTAX

```
New-VSPinpointEmailChannel [-LogicalId] <String> [-ConfigurationSet <Object>] -FromAddress <Object>
 [-Enabled <Object>] -ApplicationId <Object> -Identity <Object> [-RoleArn <Object>] [-DeletionPolicy <String>]
