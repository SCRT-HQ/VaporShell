...
```
New-VSAppFlowConnectorProfile [-LogicalId] <String> -ConnectorProfileName <Object> [-KMSArn <Object>]
 -ConnectorType <Object> -ConnectionMode <Object> [-ConnectorProfileConfig <Object>] [-DeletionPolicy <String>]
...
### Vaporshell.Resource.AppFlow.ConnectorProfile
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appflow-connectorprofile.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appflow-connectorprofile.html)
