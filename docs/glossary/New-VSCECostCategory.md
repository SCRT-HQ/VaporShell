...
```
New-VSCECostCategory [-LogicalId] <String> -Name <Object> -RuleVersion <Object> -Rules <Object>
...
If there are multiple rules that match the line item, then the first rule to match is used to determine that Cost Category value.
...
### Vaporshell.Resource.CE.CostCategory
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ce-costcategory.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ce-costcategory.html)
