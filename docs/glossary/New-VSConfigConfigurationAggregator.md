---
layout: glossary
title: New-VSConfigConfigurationAggregator
categories: glossary
label1: Category
data1: Documentation
label2: Depth
...
```
New-VSConfigConfigurationAggregator [-LogicalId] <String> [-AccountAggregationSources <Object>]
 -ConfigurationAggregatorName <Object> [-OrganizationAggregationSource <Object>] [-DeletionPolicy <String>]
...
### Vaporshell.Resource.Config.ConfigurationAggregator

## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-config-configurationaggregator.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-config-configurationaggregator.html)
