...
online version: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-as-lifecyclehook.html
schema: 2.0.0
---
...
New-VSAutoScalingLifecycleHook [-LogicalId] <String> -AutoScalingGroupName <Object> [-DefaultResult <Object>]
 [-HeartbeatTimeout <Int32>] -LifecycleTransition <Object> [-NotificationMetadata <Object>]
 [-NotificationTargetARN <Object>] [-RoleARN <Object>] [-DeletionPolicy <String>] [-DependsOn <String[]>]
