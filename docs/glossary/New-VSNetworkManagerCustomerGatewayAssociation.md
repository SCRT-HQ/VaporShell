...
The customer gateway must be connected to a VPN attachment on a transit gateway that's registered in your global network.

## SYNTAX

```
New-VSNetworkManagerCustomerGatewayAssociation [-LogicalId] <String> -GlobalNetworkId <Object>
 -CustomerGatewayArn <Object> -DeviceId <Object> [-LinkId <Object>] [-DeletionPolicy <String>]
...
### Vaporshell.Resource.NetworkManager.CustomerGatewayAssociation
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-networkmanager-customergatewayassociation.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-networkmanager-customergatewayassociation.html)
