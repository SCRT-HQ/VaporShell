...
```
New-VSMediaPackageChannel [-LogicalId] <String> -Id <Object> [-Description <Object>] [-Tags <Object>]
...
### Vaporshell.Resource.MediaPackage.Channel
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-mediapackage-channel.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-mediapackage-channel.html)
