...
online version: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iam-role.html
schema: 2.0.0
---
...
```
New-VSIAMRole [-LogicalId] <String> -AssumeRolePolicyDocument <Object> [-ManagedPolicyArns <Object>]
 [-Path <Object>] [-Policies <Object>] [-RoleName <Object>] [-DeletionPolicy <String>] [-DependsOn <String[]>]
