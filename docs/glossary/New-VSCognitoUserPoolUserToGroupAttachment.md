...
online version: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cognito-userpoolusertogroupattachment.html
schema: 2.0.0
---
...
```
New-VSCognitoUserPoolUserToGroupAttachment [-LogicalId] <String> -GroupName <Object> -UserPoolId <Object>
 -Username <Object> [-DeletionPolicy <String>] [-DependsOn <String[]>] [-Metadata <Object>]
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cognito-userpoolusertogroupattachment.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cognito-userpoolusertogroupattachment.html)
