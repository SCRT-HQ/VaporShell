...
```
New-VSKinesisAnalyticsV2ApplicationReferenceDataSource [-LogicalId] <String> -ApplicationName <Object>
 -ReferenceDataSource <Object> [-DeletionPolicy <String>] [-DependsOn <String[]>] [-Metadata <Object>]
...
In the request, you provide the source (S3 bucket name and object key name, name of the in-application table to create, and the necessary mapping information that describes how data in an Amazon S3 object maps to columns in the resulting in-application table.
...
### Vaporshell.Resource.KinesisAnalyticsV2.ApplicationReferenceDataSource
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-kinesisanalyticsv2-applicationreferencedatasource.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-kinesisanalyticsv2-applicationreferencedatasource.html)
