...
```
New-VSAppFlowFlow [-LogicalId] <String> -FlowName <Object> [-Description <Object>] [-KMSArn <Object>]
 -TriggerConfig <Object> -SourceFlowConfig <Object> -DestinationFlowConfigList <Object> -Tasks <Object>
...
### Vaporshell.Resource.AppFlow.Flow
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appflow-flow.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appflow-flow.html)
