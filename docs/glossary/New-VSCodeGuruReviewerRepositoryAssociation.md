...
```
New-VSCodeGuruReviewerRepositoryAssociation [-LogicalId] <String> -Name <Object> -Type <Object>
 [-Owner <Object>] [-ConnectionArn <Object>] [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
...
### Vaporshell.Resource.CodeGuruReviewer.RepositoryAssociation
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-codegurureviewer-repositoryassociation.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-codegurureviewer-repositoryassociation.html)
