...
```
New-VSApiGatewayDomainName [-LogicalId] <String> [-CertificateArn <Object>] -DomainName <Object>
 [-EndpointConfiguration <Object>] [-RegionalCertificateArn <Object>] [-DeletionPolicy <String>]
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apigateway-domainname.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apigateway-domainname.html)
