...
```
New-VSAmplifyDomain [-LogicalId] <String> -SubDomainSettings <Object> -AppId <Object> -DomainName <Object>
...
### Vaporshell.Resource.Amplify.Domain
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-amplify-domain.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-amplify-domain.html)
