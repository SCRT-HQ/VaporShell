...
```
New-VSTimestreamDatabase [-LogicalId] <String> [-DatabaseName <Object>] [-KmsKeyId <Object>] [-Tags <Object>]
...
### Vaporshell.Resource.Timestream.Database
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-timestream-database.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-timestream-database.html)
