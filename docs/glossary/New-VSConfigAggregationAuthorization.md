...
```
New-VSConfigAggregationAuthorization [-LogicalId] <String> -AuthorizedAccountId <Object>
 -AuthorizedAwsRegion <Object> [-Tags <Object>] [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-config-aggregationauthorization.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-config-aggregationauthorization.html)
