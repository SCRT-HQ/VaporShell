...
```
New-VSEC2SecurityGroupIngress [-LogicalId] <String> [-CidrIp <Object>] [-CidrIpv6 <Object>] [-FromPort <Int32>]
 [-GroupId <Object>] [-GroupName <Object>] -IpProtocol <Object> [-SourceSecurityGroupId <Object>]
 [-SourceSecurityGroupName <Object>] [-SourceSecurityGroupOwnerId <Object>] [-ToPort <Int32>]
