...
New-VSSageMakerEndpointConfig [-LogicalId] <String> -ProductionVariants <Object> [-KmsKeyId <Object>]
 [-EndpointConfigName <Object>] [-Tags <Object>] [-DeletionPolicy <String>] [-DependsOn <String[]>]
...
You specify this name in a CreateEndpoint: https://docs.aws.amazon.com/sagemaker/latest/dg/API_CreateEndpoint.html request.
