...
```
New-VSCognitoUserPoolDomain [-LogicalId] <String> -UserPoolId <Object> [-CustomDomainConfig <Object>]
 -Domain <Object> [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>] [-DependsOn <String[]>]
...
Don't use a hyphen for the first or last character.
...
### Vaporshell.Resource.Cognito.UserPoolDomain
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cognito-userpooldomain.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cognito-userpooldomain.html)
