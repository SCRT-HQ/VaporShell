...
```
New-VSGuardDutyIPSet [-LogicalId] <String> -Format <Object> -Activate <Object> -DetectorId <Object>
 [-Name <Object>] -Location <Object> [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
