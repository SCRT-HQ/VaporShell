...
online version: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ecr-repository.html
schema: 2.0.0
---
...
```
New-VSECRRepository [-LogicalId] <String> [-RepositoryName <Object>] [-RepositoryPolicyText <Object>]
