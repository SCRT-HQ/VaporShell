...
```
New-VSServiceCatalogStackSetConstraint [-LogicalId] <String> -Description <Object>
 -StackInstanceControl <Object> [-AcceptLanguage <Object>] -PortfolioId <Object> -ProductId <Object>
 -RegionList <Object> -AdminRole <Object> -AccountList <Object> -ExecutionRole <Object>
...
### Vaporshell.Resource.ServiceCatalog.StackSetConstraint
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-servicecatalog-stacksetconstraint.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-servicecatalog-stacksetconstraint.html)
