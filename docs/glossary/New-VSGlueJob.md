...
```
New-VSGlueJob [-LogicalId] <String> -Role <Object> [-DefaultArguments <Object>] [-Connections <Object>]
 [-MaxRetries <Double>] [-Description <Object>] [-LogUri <Object>] -Command <Object>
 [-AllocatedCapacity <Double>] [-ExecutionProperty <Object>] [-Name <Object>] [-DeletionPolicy <String>]
