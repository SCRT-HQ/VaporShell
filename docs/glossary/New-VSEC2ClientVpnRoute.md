...
Each route in the route table specifies the path for traﬃc to speciﬁc resources or networks.

## SYNTAX

```
New-VSEC2ClientVpnRoute [-LogicalId] <String> -ClientVpnEndpointId <Object> -TargetVpcSubnetId <Object>
 [-Description <Object>] -DestinationCidrBlock <Object> [-DeletionPolicy <String>] [-DependsOn <String[]>]
