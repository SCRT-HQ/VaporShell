...
```
New-VSTimestreamTable [-LogicalId] <String> -DatabaseName <Object> [-TableName <Object>]
 [-RetentionProperties <Object>] [-Tags <Object>] [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
...
### Vaporshell.Resource.Timestream.Table
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-timestream-table.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-timestream-table.html)
