...
```
New-VSDAXParameterGroup [-LogicalId] <String> [-ParameterNameValues <Object>] [-Description <Object>]
 [-ParameterGroupName <Object>] [-DeletionPolicy <String>] [-DependsOn <String[]>] [-Metadata <Object>]
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dax-parametergroup.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dax-parametergroup.html)
