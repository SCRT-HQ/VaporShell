...
```
New-VSApiGatewayGatewayResponse [-LogicalId] <String> [-ResponseParameters <Hashtable>]
 [-ResponseTemplates <Hashtable>] -ResponseType <Object> -RestApiId <Object> [-StatusCode <Object>]
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apigateway-gatewayresponse.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apigateway-gatewayresponse.html)
