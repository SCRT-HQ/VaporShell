...
```
New-VSRoute53ResolverResolverQueryLoggingConfigAssociation [-LogicalId] <String>
 [-ResolverQueryLogConfigId <Object>] [-ResourceId <Object>] [-DeletionPolicy <String>]
...
### Vaporshell.Resource.Route53Resolver.ResolverQueryLoggingConfigAssociation
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-route53resolver-resolverqueryloggingconfigassociation.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-route53resolver-resolverqueryloggingconfigassociation.html)
