# New-VSEC2ClientVpnAuthorizationRule
...
You must configure ingress authorization rules to enable clients to access resources in AWS or on-premises networks.

## SYNTAX

```
New-VSEC2ClientVpnAuthorizationRule [-LogicalId] <String> -ClientVpnEndpointId <Object> [-Description <Object>]
 [-AccessGroupId <Object>] -TargetNetworkCidr <Object> [-AuthorizeAllGroups <Boolean>]
...
Use true to grant all clients who successfully establish a VPN connection access to the network.
...
### Vaporshell.Resource.EC2.ClientVpnAuthorizationRule
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-clientvpnauthorizationrule.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-clientvpnauthorizationrule.html)
