---
layout: glossary
title: Add-VSApiGatewayDeploymentMethodSetting
categories: glossary
---
...
Add-VSApiGatewayDeploymentMethodSetting [[-CacheDataEncrypted] <Boolean>] [[-CacheTtlInSeconds] <Int32>]
 ...
 [[-ThrottlingBurstLimit] <Int32>] [[-ThrottlingRateLimit] <Double>]
```
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-apitgateway-deployment-stagedescription-methodsetting.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-apitgateway-deployment-stagedescription-methodsetting.html)
