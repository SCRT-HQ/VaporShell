...
```
New-VSApiGatewayRequestValidator [-LogicalId] <String> [-Name <Object>] -RestApiId <Object>
 [-ValidateRequestBody <Boolean>] [-ValidateRequestParameters <Boolean>] [-DeletionPolicy <String>]
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apigateway-requestvalidator.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apigateway-requestvalidator.html)
