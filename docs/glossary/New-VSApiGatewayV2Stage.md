# New-VSApiGatewayV2Stage

## SYNOPSIS
Adds an AWS::ApiGatewayV2::Stage resource to the template.
The AWS::ApiGatewayV2::Stage resource updates a stage for a WebSocket API.
For more information, see Deploy a WebSocket API in API Gateway: https://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-set-up-websocket-deployment.html in the *API Gateway Developer Guide*.

## SYNTAX

```
New-VSApiGatewayV2Stage [-LogicalId] <String> [-ClientCertificateId <Object>] -DeploymentId <Object>
 [-Description <Object>] [-AccessLogSettings <Object>] [-RouteSettings <Object>] -StageName <Object>
 [-StageVariables <Object>] -ApiId <Object> [-DefaultRouteSettings <Object>] [-Tags <Object>]
...
### Vaporshell.Resource.ApiGatewayV2.Stage
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apigatewayv2-stage.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apigatewayv2-stage.html)
