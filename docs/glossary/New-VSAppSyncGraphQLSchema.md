...
```
New-VSAppSyncGraphQLSchema [-LogicalId] <String> [-Definition <Object>] [-DefinitionS3Location <Object>]
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appsync-graphqlschema.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appsync-graphqlschema.html)
