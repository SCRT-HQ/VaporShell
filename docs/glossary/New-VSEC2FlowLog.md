...
online version: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-flowlog.html
schema: 2.0.0
---
...
```
New-VSEC2FlowLog [-LogicalId] <String> -DeliverLogsPermissionArn <Object> -LogGroupName <Object>
 -ResourceId <Object> -ResourceType <Object> -TrafficType <Object> [-DeletionPolicy <String>]
