...
A ThreatIntelSet consists of known malicious IP addresses.
GuardDuty generates findings based on the ThreatIntelSet when it is activated.

## SYNTAX

```
New-VSGuardDutyThreatIntelSet [-LogicalId] <String> -Format <Object> -Activate <Object> -DetectorId <Object>
...
### -Name
A name for the ThreatIntelSet.
The name is displayed in all finding generated by activity associated with the IP addresses included in this ThreatIntelSet.
