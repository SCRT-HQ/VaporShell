---
layout: glossary
title: New-VSGuardDutyThreatIntelSet
categories: glossary
label1: Category
data1: Documentation
label2: Depth
...
```
New-VSGuardDutyThreatIntelSet [-LogicalId] <String> -Format <Object> -Activate <Boolean> -DetectorId <Object>
...
### Vaporshell.Resource.GuardDuty.ThreatIntelSet

## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-guardduty-threatintelset.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-guardduty-threatintelset.html)
