...
```
New-VSIoT1ClickDevice [-LogicalId] <String> -DeviceId <Object> -Enabled <Boolean> [-DeletionPolicy <String>]
...
### Vaporshell.Resource.IoT1Click.Device
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iot1click-device.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iot1click-device.html)
