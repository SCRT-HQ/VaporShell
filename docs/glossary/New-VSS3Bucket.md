...
online version: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-bucket.html
schema: 2.0.0
---
...
```
New-VSS3Bucket [-LogicalId] <String> [-AccessControl <Object>] [-BucketName <Object>]
 [-CorsConfiguration <Object>] [-LifecycleConfiguration <Object>] [-LoggingConfiguration <Object>]
 [-NotificationConfiguration <Object>] [-ReplicationConfiguration <Object>] [-Tags <Object>]
 [-VersioningConfiguration <Object>] [-WebsiteConfiguration <Object>] [-DeletionPolicy <String>]
