...
online version: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iam-user.html
schema: 2.0.0
---
...
New-VSIAMUser [-LogicalId] <String> [-Groups <Object>] [-LoginProfile <Object>] [-ManagedPolicyArns <Object>]
 [-Path <Object>] [-Policies <Object>] [-UserName <Object>] [-DeletionPolicy <String>] [-DependsOn <String[]>]
