...
online version: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-codedeploy-application.html
schema: 2.0.0
---
...
```
New-VSCodeDeployApplication [-LogicalId] <String> [-ApplicationName <Object>] [-DeletionPolicy <String>]
