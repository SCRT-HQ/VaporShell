...
```
New-VSIoTAnalyticsChannel [-LogicalId] <String> [-ChannelName <Object>] [-ChannelStorage <Object>]
...
### Vaporshell.Resource.IoTAnalytics.Channel
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iotanalytics-channel.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iotanalytics-channel.html)
