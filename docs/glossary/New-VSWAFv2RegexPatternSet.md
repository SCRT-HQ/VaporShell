...
```
New-VSWAFv2RegexPatternSet [-LogicalId] <String> [-Description <Object>] [-Name <Object>]
 -RegularExpressionList <Object> -Scope <Object> [-Tags <Object>] [-DeletionPolicy <String>]
...
You cannot change the description of a set after you create it.
...
### Vaporshell.Resource.WAFv2.RegexPatternSet
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafv2-regexpatternset.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafv2-regexpatternset.html)
