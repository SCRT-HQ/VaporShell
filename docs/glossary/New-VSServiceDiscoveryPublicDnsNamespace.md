---
layout: glossary
title: New-VSServiceDiscoveryPublicDnsNamespace
categories: glossary
label1: Category
data1: Documentation
label2: Depth
...
```
New-VSServiceDiscoveryPublicDnsNamespace [-LogicalId] <String> [-Description <Object>] -Name <Object>
...
### Vaporshell.Resource.ServiceDiscovery.PublicDnsNamespace

## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-servicediscovery-publicdnsnamespace.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-servicediscovery-publicdnsnamespace.html)
