...
```
New-VSCloudWatchDashboard [-LogicalId] <String> [-DashboardName <Object>] -DashboardBody <Object>
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloudwatch-dashboard.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloudwatch-dashboard.html)
