# New-VSEventSchemasRegistry

## SYNOPSIS
Adds an AWS::EventSchemas::Registry resource to the template.
Use the AWS::EventSchemas::Registry to specify a schema registry.
Schema registries are containers for Schemas.
Registries collect and organize schemas so that your schemas are in logical groups.

## SYNTAX

```
New-VSEventSchemasRegistry [-LogicalId] <String> [-Description <Object>] [-RegistryName <Object>]
...
### Vaporshell.Resource.EventSchemas.Registry
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-eventschemas-registry.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-eventschemas-registry.html)
