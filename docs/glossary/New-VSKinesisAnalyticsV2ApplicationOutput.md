...
```
New-VSKinesisAnalyticsV2ApplicationOutput [-LogicalId] <String> -ApplicationName <Object> -Output <Object>
...
You can use the DescribeApplication: https://docs.aws.amazon.com/kinesisanalytics/latest/apiv2/API_DescribeApplication.html operation to find the current application version.
...
### Vaporshell.Resource.KinesisAnalyticsV2.ApplicationOutput
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-kinesisanalyticsv2-applicationoutput.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-kinesisanalyticsv2-applicationoutput.html)
