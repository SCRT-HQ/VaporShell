---
layout: glossary
title: New-VSInspectorAssessmentTemplate
categories: glossary
label1: Category
data1: Documentation
label2: Depth
...
# New-VSInspectorAssessmentTemplate
...
```
New-VSInspectorAssessmentTemplate [-LogicalId] <String> -AssessmentTargetArn <Object>
 -DurationInSeconds <Int32> [-AssessmentTemplateName <Object>] -RulesPackageArns <Object>
 [-UserAttributesForFindings <Object>] [-DeletionPolicy <String>] [-DependsOn <String[]>] [-Metadata <Object>]
...
### Vaporshell.Resource.Inspector.AssessmentTemplate
