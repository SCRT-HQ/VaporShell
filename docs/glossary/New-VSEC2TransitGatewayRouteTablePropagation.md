...
```
New-VSEC2TransitGatewayRouteTablePropagation [-LogicalId] <String> -TransitGatewayRouteTableId <Object>
 -TransitGatewayAttachmentId <Object> [-DeletionPolicy <String>] [-DependsOn <String[]>] [-Metadata <Object>]
...
### Vaporshell.Resource.EC2.TransitGatewayRouteTablePropagation
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-transitgatewayroutetablepropagation.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-transitgatewayroutetablepropagation.html)
