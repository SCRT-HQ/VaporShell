...
```
New-VSSSOAssignment [-LogicalId] <String> -InstanceArn <Object> -TargetId <Object> -TargetType <Object>
 -PermissionSetArn <Object> -PrincipalType <Object> -PrincipalId <Object> [-DeletionPolicy <String>]
...
### Vaporshell.Resource.SSO.Assignment
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sso-assignment.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sso-assignment.html)
