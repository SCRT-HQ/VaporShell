...
```
New-VSDirectoryServiceMicrosoftAD [-LogicalId] <String> [-CreateAlias <Boolean>] [-EnableSso <Boolean>]
 -Name <Object> -Password <Object> [-ShortName <Object>] -VpcSettings <Object> [-DeletionPolicy <String>]
