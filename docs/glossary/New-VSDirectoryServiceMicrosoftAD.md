...
```
New-VSDirectoryServiceMicrosoftAD [-LogicalId] <String> [-CreateAlias <Boolean>] [-Edition <Object>]
 [-EnableSso <Boolean>] -Name <Object> -Password <Object> [-ShortName <Object>] -VpcSettings <Object>
