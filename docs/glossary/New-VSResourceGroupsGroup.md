...
```
New-VSResourceGroupsGroup [-LogicalId] <String> -Name <Object> [-Description <Object>]
 [-ResourceQuery <Object>] [-Tags <Object>] [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
...
Specify a name that is unique in the Region.
To create multiple resource groups based on the same CloudFormation stack, use unique names for each.
...
### Vaporshell.Resource.ResourceGroups.Group
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-resourcegroups-group.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-resourcegroups-group.html)
