...
```
New-VSRAMResourceShare [-LogicalId] <String> [-Principals <Object>] [-AllowExternalPrincipals <Boolean>]
 [-ResourceArns <Object>] [-Tags <Object>] -Name <Object> [-DeletionPolicy <String>] [-DependsOn <String[]>]
...
The possible values are IDs of AWS accounts, the ARN of an OU or organization from AWS Organizations.
...
### Vaporshell.Resource.RAM.ResourceShare
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ram-resourceshare.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ram-resourceshare.html)
