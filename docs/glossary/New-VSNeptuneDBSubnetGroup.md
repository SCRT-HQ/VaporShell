...
```
New-VSNeptuneDBSubnetGroup [-LogicalId] <String> [-DBSubnetGroupName <Object>]
 -DBSubnetGroupDescription <Object> -SubnetIds <Object> [-Tags <Object>] [-DeletionPolicy <String>]
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-neptune-dbsubnetgroup.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-neptune-dbsubnetgroup.html)
