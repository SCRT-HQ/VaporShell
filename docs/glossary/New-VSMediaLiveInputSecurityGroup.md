# New-VSMediaLiveInputSecurityGroup
...
```
New-VSMediaLiveInputSecurityGroup [-LogicalId] <String> [-WhitelistRules <Object>] [-Tags <Object>]
...
A MediaLive input security group is associated with a MediaLive input.
The input security group is an "allow list" of IP addresses that controls whether an external IP address can push content to the associated MediaLive input.
...
### Vaporshell.Resource.MediaLive.InputSecurityGroup
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-medialive-inputsecuritygroup.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-medialive-inputsecuritygroup.html)
