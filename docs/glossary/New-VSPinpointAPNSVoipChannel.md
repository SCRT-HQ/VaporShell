...
Before you can use Amazon Pinpoint to send VoIP notifications to APNs, you have to enable the APNs VoIP channel for an Amazon Pinpoint application.

## SYNTAX

```
New-VSPinpointAPNSVoipChannel [-LogicalId] <String> [-BundleId <Object>] [-PrivateKey <Object>]
 [-Enabled <Object>] [-DefaultAuthenticationMethod <Object>] [-TokenKey <Object>] -ApplicationId <Object>
