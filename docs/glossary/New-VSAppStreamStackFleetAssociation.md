...
```
New-VSAppStreamStackFleetAssociation [-LogicalId] <String> -FleetName <Object> -StackName <Object>
...
### Vaporshell.Resource.AppStream.StackFleetAssociation
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appstream-stackfleetassociation.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appstream-stackfleetassociation.html)
