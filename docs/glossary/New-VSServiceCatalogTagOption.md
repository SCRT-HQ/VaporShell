...
```
New-VSServiceCatalogTagOption [-LogicalId] <String> [-Active <Boolean>] -Value <Object> -Key <Object>
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-servicecatalog-tagoption.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-servicecatalog-tagoption.html)
