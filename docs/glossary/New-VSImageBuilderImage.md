...
```
New-VSImageBuilderImage [-LogicalId] <String> [-ImageTestsConfiguration <Object>] -ImageRecipeArn <Object>
...
### Vaporshell.Resource.ImageBuilder.Image
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-imagebuilder-image.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-imagebuilder-image.html)
