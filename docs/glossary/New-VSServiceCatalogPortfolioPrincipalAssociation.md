...
```
New-VSServiceCatalogPortfolioPrincipalAssociation [-LogicalId] <String> -PrincipalARN <Object>
 [-AcceptLanguage <Object>] -PortfolioId <Object> -PrincipalType <Object> [-DeletionPolicy <String>]
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-servicecatalog-portfolioprincipalassociation.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-servicecatalog-portfolioprincipalassociation.html)
