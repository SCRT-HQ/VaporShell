...
online version: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-network-interface-attachment.html
schema: 2.0.0
---
...
```
New-VSEC2NetworkInterfaceAttachment [-LogicalId] <String> [-DeleteOnTermination <Boolean>]
 -DeviceIndex <Object> -InstanceId <Object> -NetworkInterfaceId <Object> [-DeletionPolicy <String>]
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-network-interface-attachment.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-network-interface-attachment.html)
