...
```
New-VSEC2LaunchTemplate [-LogicalId] <String> [-LaunchTemplateName <Object>] [-LaunchTemplateData <Object>]
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-launchtemplate.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-launchtemplate.html)
