...
```
New-VSIoTAnalyticsDatastore [-LogicalId] <String> [-DatastoreStorage <Object>] [-DatastoreName <Object>]
...
### Vaporshell.Resource.IoTAnalytics.Datastore
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iotanalytics-datastore.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iotanalytics-datastore.html)
