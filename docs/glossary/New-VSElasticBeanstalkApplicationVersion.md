...
online version: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-beanstalk-version.html
schema: 2.0.0
---
...
```
New-VSElasticBeanstalkApplicationVersion [-LogicalId] <String> -ApplicationName <Object>
 [-Description <Object>] -SourceBundle <Object> [-DeletionPolicy <String>] [-DependsOn <String[]>]
...
[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-beanstalk-version.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-beanstalk-version.html)
