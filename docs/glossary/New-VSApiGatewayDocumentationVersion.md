---
layout: glossary
title: New-VSApiGatewayDocumentationVersion
categories: glossary
label1: Category
data1: Documentation
label2: Depth
...
```
New-VSApiGatewayDocumentationVersion [-LogicalId] <String> [-Description <Object>]
 -DocumentationVersion <Object> -RestApiId <Object> [-DeletionPolicy <String>] [-DependsOn <String[]>]
...
### Vaporshell.Resource.ApiGateway.DocumentationVersion

## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apigateway-documentationversion.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apigateway-documentationversion.html)
