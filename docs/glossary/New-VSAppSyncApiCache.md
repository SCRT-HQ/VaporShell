...
```
New-VSAppSyncApiCache [-LogicalId] <String> -Type <Object> [-TransitEncryptionEnabled <Object>]
 [-AtRestEncryptionEnabled <Object>] -ApiId <Object> -ApiCachingBehavior <Object> -Ttl <Object>
...
This setting cannot be updated after creation.
...
### Vaporshell.Resource.AppSync.ApiCache
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appsync-apicache.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appsync-apicache.html)
