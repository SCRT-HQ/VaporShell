...
```
New-VSConfigConformancePack [-LogicalId] <String> -ConformancePackName <Object> -DeliveryS3Bucket <Object>
 [-DeliveryS3KeyPrefix <Object>] [-TemplateBody <Object>] [-TemplateS3Uri <Object>]
 [-ConformancePackInputParameters <Object>] [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
...
### Vaporshell.Resource.Config.ConformancePack
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-config-conformancepack.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-config-conformancepack.html)
