...
```
New-VSEFSAccessPoint [-LogicalId] <String> [-ClientToken <Object>] [-AccessPointTags <Object>]
 -FileSystemId <Object> [-PosixUser <Object>] [-RootDirectory <Object>] [-DeletionPolicy <String>]
...
### Vaporshell.Resource.EFS.AccessPoint
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-efs-accesspoint.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-efs-accesspoint.html)
