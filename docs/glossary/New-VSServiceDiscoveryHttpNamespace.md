...
```
New-VSServiceDiscoveryHttpNamespace [-LogicalId] <String> [-Description <Object>] -Name <Object>
...
### Vaporshell.Resource.ServiceDiscovery.HttpNamespace
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-servicediscovery-httpnamespace.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-servicediscovery-httpnamespace.html)
