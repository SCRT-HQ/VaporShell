# New-VSEC2TransitGatewayAttachment
...
```
New-VSEC2TransitGatewayAttachment [-LogicalId] <String> -TransitGatewayId <Object> -VpcId <Object>
 -SubnetIds <Object> [-Tags <Object>] [-DeletionPolicy <String>] [-UpdateReplacePolicy <String>]
...
### Vaporshell.Resource.EC2.TransitGatewayAttachment
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-transitgatewayattachment.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-transitgatewayattachment.html)
