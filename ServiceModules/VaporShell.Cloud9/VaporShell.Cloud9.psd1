@{
    RootModule             = 'VaporShell.Cloud9.psm1'
    ModuleVersion          = '3.0.0'
    GUID                   = '8744a431-2604-453d-a66c-0ab55eb91be1'
    Author                 = 'Nate Ferrell'
    CompanyName            = 'SCRT HQ'
    Copyright              = '(c) SCRT HQ 2020 . All rights reserved.'
    Description            = 'Service-specific module for AWS CloudFormation for service: Cloud9'
