@{
    RootModule             = 'VaporShell.WAFRegional.psm1'
    ModuleVersion          = '3.0.0'
    GUID                   = 'acd03422-2d58-4a77-a7bb-54426e3ded29'
    Author                 = 'Nate Ferrell'
    CompanyName            = 'SCRT HQ'
    Copyright              = '(c) SCRT HQ 2020 . All rights reserved.'
    Description            = 'Service-specific module for AWS CloudFormation for service: WAFRegional'
