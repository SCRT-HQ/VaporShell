@{
    RootModule             = 'VaporShell.PinpointEmail.psm1'
    ModuleVersion          = '3.0.0'
    GUID                   = '13be8fa8-c81f-4aa4-bc56-e64b1fecb609'
    Author                 = 'Nate Ferrell'
    CompanyName            = 'SCRT HQ'
    Copyright              = '(c) SCRT HQ 2020 . All rights reserved.'
    Description            = 'Service-specific module for AWS CloudFormation for service: PinpointEmail'
