@{
    RootModule             = 'VaporShell.Config.psm1'
    ModuleVersion          = '3.0.0'
    GUID                   = '55de2c3a-4305-4458-8775-89a44a4dc439'
    Author                 = 'Nate Ferrell'
    CompanyName            = 'SCRT HQ'
    Copyright              = '(c) SCRT HQ 2020 . All rights reserved.'
    Description            = 'Service-specific module for AWS CloudFormation for service: Config'
