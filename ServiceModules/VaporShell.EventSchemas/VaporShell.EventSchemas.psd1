@{
    RootModule             = 'VaporShell.EventSchemas.psm1'
    ModuleVersion          = '3.0.0'
    GUID                   = 'e2178456-4abf-4a53-8798-f71391a9ba07'
    Author                 = 'Nate Ferrell'
    CompanyName            = 'SCRT HQ'
    Copyright              = '(c) SCRT HQ 2020 . All rights reserved.'
    Description            = 'Service-specific module for AWS CloudFormation for service: EventSchemas'
