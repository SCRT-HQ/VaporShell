@{
    RootModule             = 'VaporShell.AutoScaling.psm1'
    ModuleVersion          = '3.0.0'
    GUID                   = '3e2f38ab-27f2-499b-a30d-f2bee952cbb0'
    Author                 = 'Nate Ferrell'
    CompanyName            = 'SCRT HQ'
    Copyright              = '(c) SCRT HQ 2020 . All rights reserved.'
    Description            = 'Service-specific module for AWS CloudFormation for service: AutoScaling'
