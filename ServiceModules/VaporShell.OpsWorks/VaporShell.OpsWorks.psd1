@{
    RootModule             = 'VaporShell.OpsWorks.psm1'
    ModuleVersion          = '3.0.0'
    GUID                   = 'd21d2c6a-a3ba-445e-acee-1117dc433864'
    Author                 = 'Nate Ferrell'
    CompanyName            = 'SCRT HQ'
    Copyright              = '(c) SCRT HQ 2020 . All rights reserved.'
    Description            = 'Service-specific module for AWS CloudFormation for service: OpsWorks'
