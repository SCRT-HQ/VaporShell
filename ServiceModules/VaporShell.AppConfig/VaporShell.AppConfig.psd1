@{
    RootModule             = 'VaporShell.AppConfig.psm1'
    ModuleVersion          = '3.0.0'
    GUID                   = '288c8159-4851-470f-8aa7-dbae6252ccba'
    Author                 = 'Nate Ferrell'
    CompanyName            = 'SCRT HQ'
    Copyright              = '(c) SCRT HQ 2020 . All rights reserved.'
    Description            = 'Service-specific module for AWS CloudFormation for service: AppConfig'
