@{
    RootModule             = 'VaporShell.IoT1Click.psm1'
    ModuleVersion          = '3.0.0'
    GUID                   = '5227bdc5-173e-4685-91f0-bdf57cbde637'
    Author                 = 'Nate Ferrell'
    CompanyName            = 'SCRT HQ'
    Copyright              = '(c) SCRT HQ 2020 . All rights reserved.'
    Description            = 'Service-specific module for AWS CloudFormation for service: IoT1Click'
