@{
    RootModule             = 'VaporShell.ApiGateway.psm1'
    ModuleVersion          = '3.0.0'
    GUID                   = '48bf89a5-e8e2-4909-ad62-19ed53be4bc6'
    Author                 = 'Nate Ferrell'
    CompanyName            = 'SCRT HQ'
    Copyright              = '(c) SCRT HQ 2020 . All rights reserved.'
    Description            = 'Service-specific module for AWS CloudFormation for service: ApiGateway'
