@{
    RootModule             = 'VaporShell.DirectoryService.psm1'
    ModuleVersion          = '3.0.0'
    GUID                   = '278d48ca-0533-48a8-9718-7c169f101ff2'
    Author                 = 'Nate Ferrell'
    CompanyName            = 'SCRT HQ'
    Copyright              = '(c) SCRT HQ 2020 . All rights reserved.'
    Description            = 'Service-specific module for AWS CloudFormation for service: DirectoryService'
