@{
    RootModule             = 'VaporShell.Inspector.psm1'
    ModuleVersion          = '3.0.0'
    GUID                   = '3648bba6-a776-441b-be8e-991172e069bf'
    Author                 = 'Nate Ferrell'
    CompanyName            = 'SCRT HQ'
    Copyright              = '(c) SCRT HQ 2020 . All rights reserved.'
    Description            = 'Service-specific module for AWS CloudFormation for service: Inspector'
