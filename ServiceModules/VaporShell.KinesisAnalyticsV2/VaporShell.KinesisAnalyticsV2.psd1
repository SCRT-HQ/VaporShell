@{
    RootModule             = 'VaporShell.KinesisAnalyticsV2.psm1'
    ModuleVersion          = '3.0.0'
    GUID                   = 'd4f9008f-d84e-481c-ab8c-cf80f4a22751'
    Author                 = 'Nate Ferrell'
    CompanyName            = 'SCRT HQ'
    Copyright              = '(c) SCRT HQ 2020 . All rights reserved.'
    Description            = 'Service-specific module for AWS CloudFormation for service: KinesisAnalyticsV2'
