@{
    RootModule             = 'VaporShell.CodeStarConnections.psm1'
    ModuleVersion          = '3.0.0'
    GUID                   = 'ba2500e0-08a0-4f9d-998d-5be8f137adba'
    Author                 = 'Nate Ferrell'
    CompanyName            = 'SCRT HQ'
    Copyright              = '(c) SCRT HQ 2020 . All rights reserved.'
    Description            = 'Service-specific module for AWS CloudFormation for service: CodeStarConnections'
