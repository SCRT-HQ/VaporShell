@{
    RootModule             = 'VaporShell.CodeCommit.psm1'
    ModuleVersion          = '3.0.0'
    GUID                   = 'ed4c6de6-716b-47ab-9c44-30deaa84eed4'
    Author                 = 'Nate Ferrell'
    CompanyName            = 'SCRT HQ'
    Copyright              = '(c) SCRT HQ 2020 . All rights reserved.'
    Description            = 'Service-specific module for AWS CloudFormation for service: CodeCommit'
