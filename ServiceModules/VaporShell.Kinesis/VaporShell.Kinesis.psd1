@{
    RootModule             = 'VaporShell.Kinesis.psm1'
    ModuleVersion          = '3.0.0'
    GUID                   = '3425dbd6-746f-40c8-acf9-ac305c61e1cd'
    Author                 = 'Nate Ferrell'
    CompanyName            = 'SCRT HQ'
    Copyright              = '(c) SCRT HQ 2020 . All rights reserved.'
    Description            = 'Service-specific module for AWS CloudFormation for service: Kinesis'
