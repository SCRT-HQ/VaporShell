@{
    RootModule             = 'VaporShell.CodeBuild.psm1'
    ModuleVersion          = '3.0.0'
    GUID                   = 'f8ec646a-673e-4538-a5a6-2965ef5ac7a0'
    Author                 = 'Nate Ferrell'
    CompanyName            = 'SCRT HQ'
    Copyright              = '(c) SCRT HQ 2020 . All rights reserved.'
    Description            = 'Service-specific module for AWS CloudFormation for service: CodeBuild'
