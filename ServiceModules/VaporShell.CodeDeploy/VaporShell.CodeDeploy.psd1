@{
    RootModule             = 'VaporShell.CodeDeploy.psm1'
    ModuleVersion          = '3.0.0'
    GUID                   = '724f75d7-bd77-4c7c-a693-56e797abbf5f'
    Author                 = 'Nate Ferrell'
    CompanyName            = 'SCRT HQ'
    Copyright              = '(c) SCRT HQ 2020 . All rights reserved.'
    Description            = 'Service-specific module for AWS CloudFormation for service: CodeDeploy'
