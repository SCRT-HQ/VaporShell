@{
    RootModule             = 'VaporShell.CloudFormation.psm1'
    ModuleVersion          = '3.0.0'
    GUID                   = '3684dc7f-daf9-4852-b6d3-7c84bdbf228b'
    Author                 = 'Nate Ferrell'
    CompanyName            = 'SCRT HQ'
    Copyright              = '(c) SCRT HQ 2020 . All rights reserved.'
    Description            = 'Service-specific module for AWS CloudFormation for service: CloudFormation'
