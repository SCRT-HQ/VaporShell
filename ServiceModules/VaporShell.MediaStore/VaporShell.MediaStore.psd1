@{
    RootModule             = 'VaporShell.MediaStore.psm1'
    ModuleVersion          = '3.0.0'
    GUID                   = 'a48850ff-d02c-4556-bc0f-007fd86f17c5'
    Author                 = 'Nate Ferrell'
    CompanyName            = 'SCRT HQ'
    Copyright              = '(c) SCRT HQ 2020 . All rights reserved.'
    Description            = 'Service-specific module for AWS CloudFormation for service: MediaStore'
