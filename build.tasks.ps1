...
Task CleanSubmodules Init, {
    Get-ChildItem 'BuildOutput' -Directory | Where-Object {$_.Name -notin @('_autoGenerated',$ModuleName)} | ForEach-Object {
        remove $_.FullName
    }
}
...
Task PublishToPSGallery -If $psGalleryConditions {
    ...
    Get-ChildItem $SourceAdditionalModuleDirectory -Directory | ForEach-Object {
        ...
        Publish-Module -Path $subVersionDirectory -NuGetApiKey $env:NugetApiKey -Repository PSGallery
    }
